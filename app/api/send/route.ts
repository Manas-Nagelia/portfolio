...
export async function POST(req: NextRequest) {
  try {
    ...
    await transporter.sendMail({
      from: process.env.NODEMAILER_EMAIL,
      to: email,
      subject: "Thank you for contacting Manas Nagelia",
    ...
    <body>
      <div class="container">
        ...
        <div class="social-links">
          <a href="https://www.linkedin.com/in/manas-nagelia/" target="_blank">LinkedIn</a> |
          <a href="https://github.com/manas-nagelia" target="_blank">GitHub</a>
        </div>
        <p class="signature">Regards,<br>Manas Nagelia</p>
      </div>
    </body>
    </html>
  `;
